    ...
    <body>
        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl" dir="ltr" >
                    <a href="index.php" class="navbar-brand"><h1 class="text-primary display-6">Platform Stores</h1></a>
