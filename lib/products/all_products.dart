...
class AllProductsList extends StatelessWidget {
  ...
  void _confirmDelete(BuildContext context, int rowId) async {
    ...
    if (confirm == true) {
      ...
      if (response["status"] == "succeed") {
        ...
        alert_msg(context, "Error", "Failed to delete");
      }
    }
  }
        ...
        return Container(
          ...
          child: ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: () => _confirmDelete(context, product['product_id']),
            ),
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) =>
                    NewProduct(row_id: product['product_id'].toString()),
              ),
            ),
          ),
        );
