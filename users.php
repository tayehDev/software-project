...
<br>
<center>
<a class="btn btn-primary" style="background:#fdfdfd;border:1px solid #aaa;color:#000;" href="users_template.php?action=add_row&area_id=<?php echo $area_id;?>&specialty_id=<?php echo $specialty_id;?>">
...
<table class="table" dir="ltr" style="font-size:0.9em;">
    <tr>
        <th width="3%"></th>
        <th width="7%">Image</th>
    ...
    while ($row = mysqli_fetch_array($query)) {
        ...
        <tr>
            ...
            <td><?php echo $row['fullname']." ".$row['nickname']; ?></td>
